...
class SpeakerEncoder(nn.Module):
    def __init__(self):
        ...
        state = torch.load('/home/soma1/문서/swm_team_filo/zolup/Korean-FastSpeech2-Pytorch-swl/Korean-FastSpeech2-Pytorch_lora/pretrained_kss/checkpoint_lora_380000.pth.tar')
        ...
        self.se_model.load_state_dict(state, strict=False)
        self.se_model.eval()
...
if __name__ == '__main__':
    ...
    # path1 = '/home/soma1/문서/swm_team_filo/zolup/Korean-FastSpeech2-Pytorch-swl/Korean-FastSpeech2-Pytorch/results/step_350000-duration_1.0-pitch_1.0-energy_1.0_vocgan_용돈을 아껴써라.wav'
    path1 = '/home/soma1/문서/swm_team_filo/zolup/Korean-FastSpeech2-Pytorch-swl/Korean-FastSpeech2-Pytorch_lora/results/step_350000-duration_1.0-pitch_1.0-energy_1.0_vocgan_용돈을 아껴써라.wav'
    
    waveform1, _ = torchaudio.load(path1, normalize=True)

    path2 = '/home/soma1/문서/swm_team_filo/zolup/Korean-FastSpeech2-Pytorch-swl/Korean-FastSpeech2-Pytorch/kss/wavs_bak/1/1_0002.wav'
    waveform2, _ = torchaudio.load(path2, normalize=True)

    output1 = encoder(waveform1)
    output2= encoder(waveform2)
