...
### kss ###
dataset = "kss"
data_path = os.path.join("/home/kss", dataset) # Fix the path to the dataset, try removing the folders if not work
meta_name = "transcript.v.1.4.txt"	# "transcript.v.1.4.txt" or "transcript.v.1.3.txt" 
textgrid_name = "TextGrid.zip"

### set GPU number ###
train_visible_devices = "0,1,2,3" ### fixed from 0,1
...
checkpoint_path = "./ckpt_all/"
#checkpoint_path = "./ckpt_a_mult/"
#checkpoint_path = "./ckpt/kss10026"
